...
limit_data <-  limit_data[ind %in% temp]
used_data <- used_data[ind %in% temp]
...
remove(max_10, max_30, max_60, real_used, limit_data, used_data, temp_table, diff_table)

## Fonctions générant le training set et le test set qui sera pris en entrée pour la classification et la régression
...
remove(test_limit, test_used, test_max_10, test_max_30, test_max_60, training_max_10, training_max_30,
       training_max_60, training_limit, training_used, e, n_ech, p, rand_row, s, t, temp)
